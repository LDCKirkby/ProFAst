...
ggplot(data = all_points, mapping = aes(x = gFluxRatio, y = axrat, size = N100, alpha = 0.8)) + 
                                    ...
                                    geom_point(data = asteroids, mapping = aes(x = gFluxRatio, y = N100, z = axrat, color = Colour, alpha = 0.8)) + scale_colour_manual(values = c("green", "blue", "red"))# + scale_colour_gradient(name = "Asteroids", low = "darkgreen", high = "green")
...
ggplot(data = all_points, mapping = aes(x = rFluxRatio, y = axrat, size = N100, alpha = 0.8)) + 
                                    ...
                                    geom_point() + #scale_color_viridis_c(option = "A") +
                                    ggnewscale::new_scale_color() + 
                                    geom_point(data = asteroids, mapping = aes(x = rFluxRatio, y = N100, z = axrat, color = Colour, alpha = 0.8)) + scale_colour_manual(values = c("green", "blue", "red"))# + scale_colour_gradient(name = "Asteroids", low = "firebrick", high = "red")
...
ggplot(data = all_points, mapping = aes(x = iFluxRatio, y = axrat, size = N100, alpha = 0.8)) + 
                                    ...
                                    geom_point() + #scale_color_viridis_c(option = "A") +
                                    ggnewscale::new_scale_color() + 
                                    geom_point(data = asteroids, mapping = aes(x = iFluxRatio, y = N100, z = axrat, color = Colour, alpha = 0.8)) + scale_colour_manual(values = c("green", "blue", "red"))# + scale_colour_gradient(name = "Asteroids", low = "darkblue", high = "blue")
...
ggplot(data = all_points, mapping = aes(x = Entropy, y = axrat, size = N100, alpha = 0.8)) + 
                                    ...
                                    geom_point() +# scale_color_viridis_c(option = "A") +
                                    ggnewscale::new_scale_color() + 
                                    geom_point(data = asteroids, mapping = aes(x = Entropy, y = N100, z = axrat, color = Colour, alpha = 0.8)) + scale_colour_manual(values = c("green", "blue", "red"))# + scale_colour_gradient(name = "Asteroids", low = "deeppink4", high = "deeppink")
