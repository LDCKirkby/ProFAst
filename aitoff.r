...
png(filename=paste0("./projectionmap.png"),width=30.0,height=20.0,units="cm",res=240, family = "Arial Unicode MS")
...
#
magproj(12.5,-23,type="t",plottext="WAVES-South",col="maroon",add=T, family = "Arial Unicode MS")
magproj(190,7,type="t",plottext="WAVES-North",col="maroon",add=T, family = "Arial Unicode MS")
