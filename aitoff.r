...
g = ggplot(data = all_points, mapping = aes(x = gFluxRatio, y = axrat, color = N100)) + 
                                    ...
                                    geom_point(data = asteroids, mapping = aes(x = gFluxRatio, y = axrat, color = N100)) + scale_fill_viridis_c(option = "magma")
...
r = ggplot(data = all_points, mapping = aes(x = rFluxRatio, y = axrat, color = N100)) + 
                                    ...
                                    geom_point() + scale_fill_viridis_c() +
                                    ggnewscale::new_scale_fill() + 
                                    geom_point(data = asteroids, mapping = aes(x = rFluxRatio, y = axrat, color = N100)) + scale_fill_viridis_c(option = "magma")
...
i = ggplot(data = all_points, mapping = aes(x = iFluxRatio, y = axrat, color = N100)) + 
                                    ...
                                    geom_point() + scale_fill_viridis_c() +
                                    ggnewscale::new_scale_fill() + 
                                    geom_point(data = asteroids, mapping = aes(x = iFluxRatio, y = axrat, color = N100)) + scale_fill_viridis_c(option = "magma")
...
entropy = ggplot(data = all_points, mapping = aes(x = Entropy, y = axrat, color = N100)) + 
                                    ...
                                    geom_point() + scale_fill_viridis_c() +
                                    ggnewscale::new_scale_fill() + 
                                    geom_point(data = asteroids, mapping = aes(x = Entropy, y = axrat, color = N100)) + scale_fill_viridis_c(option = "magma")
