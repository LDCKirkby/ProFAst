...
magproj(-100,-100,type="p",pch=".",centre=c(60,0),latlim=c(-90,declimit),labloc=c(300,15),fliplong=FALSE, family = "sans", font = 1)
...
#
magproj(12.5,-23,type="t",plottext="WAVES-South",col="maroon",add=T, family = "sans", font = 1)
magproj(190,7,type="t",plottext="WAVES-North",col="maroon",add=T, family = "sans", font = 1)
