...
ggplot(data = all_points, mapping = aes(x = gFluxRatio, y = N100, z = axrat)) + 
...
par(mfrow=c(1,1),mar=c(3,3,2,2), family="Arial")
ggplot(data = all_points, mapping = aes(x = rFluxRatio, y = N100, z = axrat)) + 
...
par(mfrow=c(1,1),mar=c(3,3,2,2), family="Arial")
ggplot(data = all_points, mapping = aes(x = iFluxRatio, y = N100, z = axrat)) + 
...
par(mfrow=c(1,1),mar=c(3,3,2,2), family="Arial")
ggplot(data = all_points, mapping = aes(x = Entropy, y = N100, z = axrat)) + 
