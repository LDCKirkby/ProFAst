...
magimage(x=asteroids$gFluxRatio, y=asteroids$axrat, z=asteroids$N100, log='xy', add=TRUE, xlim = c(min(asteroids$gfluxRatio),max(asteroids$gFluxRatio)), ylim = c(min(asteroids$axrat),max(asteroids$axrat)))
...
magimage(x=asteroids$rFluxRatio, y=asteroids$axrat, z=asteroids$N100, log='xy', add=TRUE, xlim = c(min(asteroids$rfluxRatio),max(asteroids$gFluxRatio)), ylim = c(min(asteroids$axrat),max(asteroids$axrat)))
...
magimage(x=asteroids$iFluxRatio, y=asteroids$axrat, z=asteroids$N100, log='xy', add=TRUE, xlim = c(min(asteroids$ifluxRatio),max(asteroids$gFluxRatio)), ylim = c(min(asteroids$axrat),max(asteroids$axrat)))
...
magimage(x=asteroids$Entropy, y=asteroids$axrat, z=asteroids$N100, log='xy', add=TRUE, xlim = c(min(asteroids$Entropy),max(asteroids$gFluxRatio)), ylim = c(min(asteroids$axrat),max(asteroids$axrat)))
