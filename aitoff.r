...
g = g + new_scale_color() + geom_point(data = asteroids, mapping = aes(x = gFluxRatio, y = axrat, color = N100)) + scale_fill_viridis_c(option = "magma")
...
r = ggplot(data = all_points, mapping = aes(x = rFluxRatio, y = axrat, color = N100)) + 
                                    ...
                                    scale_y_log10() +
                                    geom_point() + scale_fill_viridis_c()
r = r + new_scale_color() + geom_point(data = asteroids, mapping = aes(x = rFluxRatio, y = axrat, color = N100)) + scale_fill_viridis_c(option = "magma")
...
i = ggplot(data = all_points, mapping = aes(x = iFluxRatio, y = axrat, color = N100)) + 
                                    ...
                                    scale_y_log10() +
                                    geom_point() + scale_fill_viridis_c()
i = i + new_scale_color() + geom_point(data = asteroids, mapping = aes(x = iFluxRatio, y = axrat, color = N100)) + scale_fill_viridis_c(option = "magma")
...
entropy = ggplot(data = all_points, mapping = aes(x = Entropy, y = axrat, color = N100)) + 
                                    ...
                                    scale_y_log10() +
                                    geom_point() + scale_fill_viridis_c()
entropy = entropy + new_scale_color() + geom_point(data = asteroids, mapping = aes(x = Entropy, y = axrat, color = N100)) + scale_fill_viridis_c(option = "magma")
