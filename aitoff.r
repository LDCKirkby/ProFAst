...
magplot(x=asteroids$gFluxRatio, y=asteroids$axrat, z=asteroids$N100, log='xy', add=TRUE, xlab = "Flux Ratio (g band)", ylab = "Axial Ratio", main = "Flux Ratio (g band) vs Axial Ratio (N100 Size Coloured)")
...
magplot(x=asteroids$rFluxRatio, y=asteroids$axrat, z=asteroids$N100, log='xy', add=TRUE, xlab = "Flux Ratio (r band)", ylab = "Axial Ratio", main = "Flux Ratio (r band) vs Axial Ratio (N100 Size Coloured)")
...
magplot(x=asteroids$iFluxRatio, y=asteroids$axrat, z=asteroids$N100, log='xy', add=TRUE, xlab = "Flux Ratio (i band)", ylab = "Axial Ratio", main = "Flux Ratio (i band) vs Axial Ratio (N100 Size Coloured)")
...
magplot(x=asteroids$Entropy, y=asteroids$axrat, z=asteroids$N100, log='xy', add=TRUE, xlab = "Entropy", ylab = "Axial Ratio", main = "Entropy vs Axial Ratio (N100 Size Coloured)")
