...
green_objects=rbind(cat_groups[flux_gt/flux_rxt>=15 | flux_gt/flux_i1xt>=15,])
red_objects=rbind(cat_groups[flux_rxt/flux_gt>=15 | flux_rxt/flux_i1xt>=15,])
blue_objects=rbind(cat_groups[flux_i1xt/flux_gt>=15 | flux_i1xt/flux_gt>=15,])

green_objects$Colour <- "g"
red_objects$Colour <- "r"
blue_objects$Colour <- "i"
