...
magproj(all_points$RAcen, all_points$Deccen, pch=21,col=rgb(0,0,0,0.2),cex=0.1,add=T,type="p",main="All Filtered Sources")
# magproj(all_points[all_points$Colour == "g",]$RAcen, all_points[all_points$Colour == "g",]$Deccen, pch=21,col=rgb(0,1,0,0.2),cex=0.1,add=T,type="p")
# magproj(all_points[all_points$Colour == "r",]$RAcen, all_points[all_points$Colour == "r",]$Deccen, pch=21,col=rgb(1,0,0,0.2),cex=0.1,add=T,type="p")
# magproj(all_points[all_points$Colour == "i",]$RAcen, all_points[all_points$Colour == "i",]$Deccen, pch=21,col=rgb(0,0,1,0.2),cex=0.1,add=T,type="p")
