...
visual_asteroids = read.csv(paste0(RA_Dec,"/",RA_Dec,"_",ast_type,".csv"), header=TRUE)
...
write.csv(verified_asteroids, file=paste0(RA_Dec,"/",RA_Dec,"_",ast_type,"_Verified.csv"))
