...
#' @param${1:axrat_value} ${2:Numeric scalar; Axial ratio filter cutoff value. Sources with an axial ratio lower than the value are assumed to not be asteroids and are removed. See ProFound documentation on how axrat value is determined.}
#' @param${1:N100_lower} ${2:Numeric scalar; N100 filter lower cutoff value. Sources with a N100 pixel count lower than the value are assumed too small to be asteroids and are removed. See ProFound documentation on how N100 value is calculated.}
#' @param${1:N100_upper} ${2:Numeric scalar; N100 filter upper cutoff calue. Sources with a N100 pixel count greater than the value are assumed too large to be asteroids and are removed. See ProFound documentation on how N100 value is calculated.}
#'
#' @export
#'
